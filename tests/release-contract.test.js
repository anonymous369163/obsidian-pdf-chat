...
test("release metadata is exactly version 0.8.0 with Obsidian 1.4.0 compatibility", () => {
...
test("release verifier validates the 0.8.0 metadata contract", () => {
  const verifier = require(path.join(projectRoot, "scripts", "verify-release.js"));

  assert.equal(verifier.RELEASE_VERSION, "0.8.0");
